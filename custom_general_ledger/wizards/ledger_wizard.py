...
class CustomLedgerWizard(models.TransientModel):
    _name = 'custom.ledger.wizard'
    _description = 'Wizard para Libro Mayor Personalizado'
    ...
    def action_print_report(self):
        ...
        return self.env.ref('custom_general_ledger.action_report_custom_ledger').report_action(self, data=data)